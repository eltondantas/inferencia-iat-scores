...
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) negativa com a matemática (média .61, desv. padrão 0.41, N = 75). Os homens também tiveram uma associação negativa com a matemática (média .24, desv. padrão .55, N = 16), porém menor que a das mulheres. Houve portanto uma considerável diferença entre homens e mulheres (diferença das médias -.37, 95% CI [-.63, -.05]). A partir desta amostra (wisc.csv), estimamos que mulheres têm uma associação negativa mais forte, com uma diferença que provavelmente está entre 0.05 e 0.63 ponto na escala IAT, o suficiente para diferenciar uma associação neutra de uma muito forte contra a matemática.
