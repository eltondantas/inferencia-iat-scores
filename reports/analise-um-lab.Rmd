...
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) com a matemática negativa e (média .61, desv. padrão YYY, N = 75). Homens tiveram uma associação **positiva/negativa** com a matemática, portanto **maior/menor** que a das mulheres (média .24, desv. padrão .55, N = 16). Houve portanto uma **grande/considerável/pequena** diferença entre homens e mulheres (diferença das médias -.37, 95% CI [CCC, DDD]). A partir desta amostra, estimamos que...
